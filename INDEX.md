...
| Rerun `notes-exporter` Markdown conversion with the project venv after a partial export | learnings/tools.md | apple-notes, notes-exporter, markdownify, python, venv, conda, export | 2026-06-14 |
...
| Scrutiny reviewer subagents may need explicit allowed files and commands to avoid permission aborts | learnings/tools.md | factory, scrutiny, task, subagent, permissions, prompts | 2026-04-05 |
...
| SwiftUI alerts must not share one binding across root and sheet presenters | learnings/gotchas.md | swiftui, alerts, sheets, presentation, ui-tests | 2026-09-21 |
...
| Paper Boy quiet-day discovery gates before feed I/O | learnings/patterns.md | paper-boy, discovery, rss, atom, sqlite, quiet-day, httpx, testing | 2026-09-07 |
